...
const decorateOrder = (order, tokens) => {
    ...
    // Example: Giving mETH in exchange for SAH
    if (order.tokenGive === tokens[1].address) {
        token0Amount = order.amountGive // The amount of SAH we are giving
        token1Amount = order.amountGet // The amount of mETH we want...
    } else {
        token0Amount = order.amountGet // The amount of mETH we want
        token1Amount = order.amountGive // The amount of SAH we are giving...
    }
